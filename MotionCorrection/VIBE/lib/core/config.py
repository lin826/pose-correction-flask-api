...
VIBE_DB_DIR = 'MotionCorrection/VIBE/data/vibe_db'
AMASS_DIR = 'MotionCorrection/VIBE/data/amass'
INSTA_DIR = 'MotionCorrection/VIBE/data/insta_variety'
MPII3D_DIR = 'MotionCorrection/VIBE/data/mpi_inf_3dhp'
THREEDPW_DIR = 'MotionCorrection/VIBE/data/3dpw'
PENNACTION_DIR = 'MotionCorrection/VIBE/data/penn_action'
POSETRACK_DIR = 'MotionCorrection/VIBE/data/posetrack'
VIBE_DATA_DIR = 'MotionCorrection/VIBE/data/vibe_data'
