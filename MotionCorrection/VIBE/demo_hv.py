...
def main_VIBE(video_dict_or_file, model, img_folder=None):
    device = torch.device('cuda') if torch.cuda.is_available() else torch.device('cpu')

    image_folder, num_frames, img_shape = video_to_images(video_dict_or_file, img_folder=img_folder, return_info=True)
